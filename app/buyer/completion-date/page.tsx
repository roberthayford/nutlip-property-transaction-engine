...
export default function BuyerCompletionDatePage() {
      ...
      <div className="space-y-6">
        ...
        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-medium">Conveyancer Managed Process</div>
              <div className="text-sm text-grey-600">
                This stage is handled by your conveyancer and the seller's conveyancer. You will be notified when they
            ...
            {completionStatus === "awaiting" && (
              <div className="flex items-center gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-grey-600">
                    Your conveyancer is coordinating with the seller's conveyancer to agree on a completion date. You
                    will be notified automatically when agreed.
                  </div>
                </div>
                    ...
                    <p className="font-semibold">
                      {completionData.completedBy === "buyer-conveyancer"
                        ...
                        : completionData.completedBy === "seller-conveyancer"
                          ...
                          : completionData.completedBy || "Your Conveyancer"}
                    </p>
                  </div>
                  <div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Your Role During Completion Date Coordination
            </CardTitle>
            <CardDescription>What you need to know and prepare for</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="p-4 bg-grey-50 rounded-lg">
              ...
              <ul className="space-y-2 text-sm text-grey-600">
                <li className="flex items-start gap-2">
                  ...
                  <span>Stay informed of the agreed completion date and prepare accordingly</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-grey-400 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Ensure your mortgage funds will be available on the completion date</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-grey-400 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Arrange buildings insurance to start from the completion date</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-grey-400 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Plan your moving arrangements and key collection</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-grey-400 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Prepare for final property inspection before completion</span>
                </li>
              </ul>
            </div>

            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <h4 className="font-medium mb-2 text-yellow-800">Important Considerations</h4>
              <ul className="space-y-2 text-sm text-yellow-700">
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Ensure your mortgage offer doesn't expire before the completion date</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Confirm you have sufficient funds for completion costs and moving expenses</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Book time off work for completion day and moving arrangements</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Notify utility companies and arrange service transfers</span>
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                {completionStatus === "completed"
                  ? "The completion date has been agreed. You can now finalise your moving arrangements, confirm your mortgage funds availability, and prepare for completion day. Your conveyancer will handle the legal aspects."
                  : "Your conveyancer will coordinate with the seller's conveyancer to agree on a suitable completion date. You'll be notified once they reach agreement and can then make your final preparations for moving."}
              </p>
            </div>

            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <h4 className="font-medium mb-2 text-green-800">Completion Day Checklist</h4>
              <ul className="space-y-2 text-sm text-green-700">
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Final property inspection (usually morning of completion)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Funds transfer completed by your conveyancer</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Legal title transfer and registration</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Key collection from estate agent</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  <span>Property becomes legally yours!</span>
                </li>
              </ul>
            </div>
