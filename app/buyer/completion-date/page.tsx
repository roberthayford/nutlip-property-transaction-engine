          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                {completionStatus === "completed"
                  ? "The completion date has been agreed. You can now finalize your moving arrangements, confirm your mortgage funds availability, and prepare for completion day. Your conveyancer will handle the legal aspects."
