              ...
              <div className="flex items-center justify-between p-3 border rounded-lg bg-green-50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Your conveyancer verified fee amount</div>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 border rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">End-to-end coordination of your property purchase</div>
                  </div>
                ...
                <div className="flex justify-between items-center p-3 border rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Secure storage and sharing of your purchase documents</div>
                  </div>
                ...
                <div className="flex justify-between items-center p-3 border rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Real-time updates on your purchase progress</div>
                  </div>
                ...
                <div className="flex justify-between items-center p-3 bg-purple-50 border border-purple-200 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Paid by your conveyancer</div>
                  </div>
