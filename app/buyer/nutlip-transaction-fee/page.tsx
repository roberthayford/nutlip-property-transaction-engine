...
export default function BuyerNutlipTransactionFeePage() {
  ...
  return (
    <TransactionLayout title="Nutlip Transaction Fee" stage="nutlip-transaction-fee" userRole="buyer">
      <div className="space-y-6">
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-sm text-blue-700 mb-3">
                This stage of the transaction process is handled entirely by <strong>your conveyancer</strong> and the{" "}
                <strong>seller's conveyancer</strong>. Your conveyancer will process the Nutlip transaction fee payment
                through our secure Open Banking system.
              </p>
              <p className="text-sm text-blue-700">
                {paymentStatus === "completed"
                  ? "The payment has been completed successfully and the transaction can now proceed to the final stages."
                  : "You will be automatically notified when this stage has been completed and the transaction can proceed to the final stages."}
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Nutlip platform fee based on your accepted property offer</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* Property Details */}
            <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
              <h4 className="font-medium text-purple-800 mb-2">Your Property Purchase Details</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <div className="text-sm text-purple-700 mb-1">Your Accepted Offer</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <div className="text-xs text-blue-700">Of your offer</div>
              </div>
                ...
                <div>
                  ...
                  <div className="text-sm text-grey-600">
                    {paymentStatus === "completed"
                      ...
                      : "Your conveyancer handling payment"}
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-sm text-blue-700">
                  The transaction fee has been successfully paid and your property purchase can now proceed to the final
                  completion stages. You will be notified of any further actions required.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg bg-green-50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-grey-600">Your conveyancer verified fee amount</div>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-grey-600">
                      {paymentStatus === "completed"
                        ? "Transaction ready to proceed to next stage"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Detailed breakdown of the Nutlip transaction services for your purchase</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 border rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-grey-600">End-to-end coordination of your property purchase</div>
                  </div>
                ...
                <div className="flex justify-between items-center p-3 border rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-grey-600">Secure storage and sharing of your purchase documents</div>
                  </div>
                ...
                <div className="flex justify-between items-center p-3 border rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-grey-600">Real-time updates on your purchase progress</div>
                  </div>
                ...
                <div className="flex justify-between items-center p-3 bg-purple-50 border border-purple-200 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-grey-600">Paid by your conveyancer</div>
                  </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Services for Your Purchase
            </CardTitle>
            <CardDescription>What the Nutlip platform fee covers for your property purchase</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Digital purchase management</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-green-600" />
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-grey-600">
                    {paymentStatus === "completed"
                      ? "✓ Ready to progress to next transaction stage"
            ...
            >
              ...
              <p className={`text-sm ${paymentStatus === "completed" ? "text-green-700" : "text-amber-700"}`}>
                {paymentStatus === "completed"
                  ? "The Nutlip transaction fee has been successfully paid. Your property purchase will now automatically progress to the final completion stages."
                  : "Once your conveyancer completes the fee payment, you will be notified and the transaction will automatically progress to the final completion stages."}
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-3 text-sm">
              <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
                ...
                <p className="text-amber-700">
                  The Nutlip transaction fee is calculated at 0.5% of your accepted property offer (£
              ...
              <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <p className="text-blue-700">
                  This stage is handled entirely by your conveyancer and the seller's conveyancer. Your conveyancer
                  processes the payment through secure Open Banking.
                </p>
              </div>
              ...
              >
                <p className="font-medium text-green-800">Your Role</p>
